export default async function handler(req, res) {
  ...
  const { mood, filters, mode, seen, systemOverride } = req.body;
  ...
  if (systemOverride) {
    ...
    system = `Tu es un cinéphile passionné et empathique. Recommande UN SEUL film selon l'état émotionnel décrit.
